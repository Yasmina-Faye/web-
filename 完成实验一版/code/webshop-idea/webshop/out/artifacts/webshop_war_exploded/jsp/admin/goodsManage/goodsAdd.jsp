...
<body>
	<div class="container">
		...
		<form id="goodsAddForm" class="form-horizontal" action="GoodsManageServlet?action=add" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label for="goodsName" class="col-sm-2 col-sm-offset-2 control-label">商品名称</label>
				<div class="col-sm-4 ">
			...
			<div class="form-group">
				<label for="goodsImg" class="col-sm-2 col-sm-offset-2 control-label">图片上传</label>
				<div class="col-sm-4">
